...
BL2_NSIHFILE="$BL2_DIR/reference-nsih/nsih_trike_ddr3_933Mhz.txt"
...
BL2_BINGEN="$BINGEN_EXE -n $BL2_NSIHFILE -i $RESULT/bl2-trike.bin
...
BUILD_IMAGES=(
	...
	"uboot 	=
		PATH  	: $UBOOT_DIR,
		CONFIG	: artik310s_trike_defconfig,
		OUTPUT	: u-boot.bin,
	...
	"dtb   	=
		PATH  	: $KERNEL_DIR,
		IMAGE 	: sip-s31nx-artik310s-trike-rev00.dtb,
		OUTPUT	: arch/arm/boot/dts/sip-s31nx-artik310s-trike-rev00.dtb,",
	"br2   	=
		PATH  	: $BR2_DIR,
		CONFIG	: artik310s_trike_sysv_defconfig,
