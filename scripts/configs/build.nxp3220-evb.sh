...
BL2_MAKEOPT="CHIPNAME=nxp3220 BOARD=evb PMIC=nxe1500"

# BINGEN Input Path
BL2_NSIH="$BL2_DIR/reference-nsih/nsih_evb_ddr3_800Mhz.txt"
...
BL2_BINGEN="$BINGEN_EXE -n $BL2_NSIH -i $RESULT/bl2-evb.bin
...
BUILD_IMAGES=(
	...
	"dtb   	=
		PATH  	: $KERNEL_DIR,
		IMAGE 	: nxp3220-evb.dtb,
		OUTPUT	: arch/arm/boot/dts/nxp3220-evb.dtb",
)
